...
data = pd.read_csv('preprocessed_atp_matches_1993-2018.csv', header=0, sep='\s*,\s*', encoding="ascii", engine='python')
...
# input layer
inputs = ll.InputLayer(24, 24)
flatten = ll.Flatten()
# network body
layer1 = ll.Dense(24)
activ = ll.Activation('relu')
dropout = ll.Dropout(0.5)
layer2 = ll.Dense(12)
layer3 = ll.Dense(6)
# output layer: 2 neurons for each class with  softmax
...
model.fit(X_train, y_train,
          validation_data=(X_test, y_test), epochs=13);
